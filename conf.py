...
BLOG_AUTHOR = "noypeban"  # (translatable)
BLOG_TITLE = "noypeban.github.io"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://noypeban.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://noypeban.github.io/"
BLOG_EMAIL = "n.tesla@example.com"
BLOG_DESCRIPTION = "This site provedes a sort of sample codes for machine-learning, \
    deep-learning, reinforcement-learning, and so on (mainly for my personal notes)."  # (translatable)
